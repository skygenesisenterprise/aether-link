...
Thank you for your interest in contributing to **Aether Link**!  
...
**Aether Link** is the official Aether Link of Sky Genesis Enterprise, licensed under **BSD-2-Clause license**, with both:
...
We follow a [Code of Conduct](https://github.com/skygenesisenterprise/aether-link/CODE_OF_CONDUCT.md) to ensure a safe, respectful, and inclusive environment.  
...
Open a [GitHub Discussion](https://github.com/skygenesisenterprise/aether-link/discussions)
Or reach out to us at [contact@skygenesisenterprise.com](mailto:contact@skygenesisenterprise.com)

Thank you for helping improve to Aether Link! 💌
