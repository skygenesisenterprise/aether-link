...
Thank you for using **Aether Link** — the official Aether Link developed and maintained by [Sky Genesis Enterprise](https://skygenesisenterprise.com).
...
If you're using the open-source version of Aether Link and need help with:
...
- 💬 [GitHub Discussions](https://github.com/skygenesisenterprise/aether-link/discussions)
- 🐞 [GitHub Issues](https://github.com/skygenesisenterprise/aether-link/issues) – for bug reports only
...
If you are using Aether Link in a professional or production environment and require:
...
Want to help improve for the Aether Link?  
